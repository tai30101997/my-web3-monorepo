...
// CHAIN_LINK ORACLE -> RANDOM NUMBER GENERATOR, AUTO EXECUTE

// ENTER_RAFFLE -> REQUEST_RANDOM_WORD ( USER CALL )--> CHAIN_LINK_VRF --> FULL_FILL_RANDOM_WORD ( CHAIN_LINK AUTO CALL ) -> PICK_WINNER_AND_TRANSFER_PRIZE
